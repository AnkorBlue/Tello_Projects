...
class ProcessadorVisao:
    ...
    def processar_frame(self, frame, tem_espelho=True):
        ...
        mask_red = cv2.add(mask_red1, mask_red2) # Soma as duas pontas do vermelho
        ...
        # ==========================================
        # Só procuramos a linha direcional se não tiver achado o alerta
