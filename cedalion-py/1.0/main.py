...
class ControladorDrone:
    def __init__(self):
        ...
        # Estados: 0:Voz/Planos, 1:Decolagem, 1.5:Estabilização, 2:Navegação(Visão), 3:Ação, 4:Pouso
        self.estado_atual = 0  
        self.plano_acoes = []
        self.acao_index = 0
    ...
    def iniciar_missao(self):
        while True:
            ...
            # ESTADO 1.5: Estabilização (O drone já subiu, agora espera o balanço parar)
                ...
                self.voz.falar("Drone estabilizado. Iniciando leitura de frames.")
                self.estado_atual = 2
            ...
            if self.estado_atual >= 2:
                ...
                # Enquanto não está navegando, apenas mostra o vídeo cru para não travar a janela
